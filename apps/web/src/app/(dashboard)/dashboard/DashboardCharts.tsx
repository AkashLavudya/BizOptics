...
export default function DashboardCharts({ stats, isLoading }: Props) {
  return (
    <div className="space-y-6">
      ...
      <div className="grid lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-3 bg-slate-900/80 border border-slate-800/50 rounded-2xl p-6">
          <h3 className="text-base font-semibold text-white mb-5">Business Discovery Trends</h3>
          {isLoading ? (
        ...
        <div className="lg:col-span-2 bg-slate-900/80 border border-slate-800/50 rounded-2xl p-6">
          <h3 className="text-base font-semibold text-white mb-5">Opportunity Types</h3>
          {isLoading ? (
            <Skeleton className="h-48 w-full" />
          ) : (
            <ResponsiveContainer width="100%" height={200}>
      ...
      <div className="bg-slate-900/80 border border-slate-800/50 rounded-2xl p-6">
        <h3 className="text-base font-semibold text-white mb-5">Businesses by Category</h3>
        {isLoading ? (
          <Skeleton className="h-48 w-full" />
        ) : (
